...
La aplicación abrirá el panel en `http://localhost:5173` (puerto por defecto de Vite).
...
Si ninguna de las opciones anteriores está definida, el frontend intentará conectarse usando las URL por defecto mencionadas arriba.
